      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 py-3 sm:py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav className="flex flex-wrap gap-4 sm:gap-8 items-center text-xs sm:text-sm">
            <Link href="/" className="text-slate-700 hover:text-amber-600 font-bold uppercase tracking-wide transition">
              Home
            </Link>
            <Link href="/catalog" className="text-slate-700 hover:text-amber-600 font-bold uppercase tracking-wide transition">
              Catalog
            </Link>
            <Link href="/#wholesale" className="text-slate-700 hover:text-amber-600 font-bold uppercase tracking-wide transition">
              Wholesale
            </Link>
            <Link href="/#contact" className="text-slate-700 hover:text-amber-600 font-bold uppercase tracking-wide transition">
              Contact
            </Link>
          </nav>
