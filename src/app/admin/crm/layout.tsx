...
export default function CRMLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (email.toLowerCase() !== 'gardenablaze@gmail.com') {
        router.push('/admin');
        return;
      }
      setAuthorized(true);
    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      >
        ...
        <div className="px-5 py-5 border-b border-slate-800">
          <div className="text-lg font-bold text-white tracking-tight">Blue Label CRM</div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 bg-slate-900 border-b border-slate-800">
          ...
          <span className="text-sm font-bold text-white">Blue Label CRM</span>
        </div>
